...
LEFT_SOLUTION_BUTTON_POS = ((WIDTH + RIGHT_DISTANCE) / 2) - (SOLUTION_BUTTON_WIDTH / 2)
...
SOLUTION_LEFT = (LEFT_SOLUTION_BUTTON_POS + SOLUTION_BUTTON_WIDTH / 2) - (4.5 * SOLUTION_SQUARE)
...
LEFT_HELPER_BUTTON_POS = ((WIDTH + RIGHT_DISTANCE) / 2) - (HELPER_BUTTON_WIDTH / 2)
...
def draw_solution_buttons():
    # Button
    pygame.draw.rect(screen, (20,20,20), pygame.Rect(LEFT_SOLUTION_BUTTON_POS, TOP_SOLUTION_BUTTON_POS, SOLUTION_BUTTON_WIDTH, SOLUTION_BUTTON_HEIGHT), 0, -1, 7, 7, 7, 7)

    # Button text
    solution_font = pygame.font.SysFont('Calibri', int(SQUARE_SIZE / 1.5))
    solution_text = solution_font.render("Show Solutions", True, (230,230,230))
    screen.blit(solution_text, (((LEFT_SOLUTION_BUTTON_POS + (SOLUTION_BUTTON_WIDTH / 2)) - (solution_text.get_width() / 2)), (TOP_SOLUTION_BUTTON_POS + (SOLUTION_BUTTON_HEIGHT / 2)) - (solution_text.get_height() * 2 / 3)))
    
    tip_font = pygame.font.SysFont('Calibri', int(SQUARE_SIZE / 2.25))
    tip_text = tip_font.render("(Press 's' to toggle)", True, (230,230,230))
    screen.blit(tip_text, (((LEFT_SOLUTION_BUTTON_POS + (SOLUTION_BUTTON_WIDTH / 2)) - (tip_text.get_width() / 2)), (TOP_SOLUTION_BUTTON_POS + (SOLUTION_BUTTON_HEIGHT / 2)) + (solution_text.get_height() / 3)))


    # Create grid
    if show_solution_grid == True:
        # Add tip
        tip2_text = tip_font.render("(Click to copy to primary board)", True, (50,50,50))
        screen.blit(tip2_text, (((LEFT_SOLUTION_BUTTON_POS + (SOLUTION_BUTTON_WIDTH / 2)) - (tip2_text.get_width() / 2)), SOLUTION_TOP - SOLUTION_SQUARE))
        ...
        for i in range(10):
            ...
            pygame.draw.line(screen, (50,50,50), (SOLUTION_LEFT + i * SOLUTION_SQUARE, SOLUTION_TOP), (SOLUTION_LEFT + i * SOLUTION_SQUARE, SOLUTION_SIZE + SOLUTION_TOP), line_width)
            pygame.draw.line(screen, (50,50,50), (SOLUTION_LEFT, SOLUTION_TOP + i * SOLUTION_SQUARE), (SOLUTION_SIZE + SOLUTION_LEFT, SOLUTION_TOP + i * SOLUTION_SQUARE), line_width)
        ...
        for i in range(9):
            for j in range(9):
                ...
                value_font = pygame.font.SysFont('Calibri', int(SOLUTION_SQUARE / 1.5))
                value = value_font.render(str(cell.value), True, cell.value_color)

                x_middle = SOLUTION_LEFT + (SOLUTION_SQUARE * j) + (SOLUTION_SQUARE * 8 / 15)
                y_middle = SOLUTION_TOP + (SOLUTION_SQUARE * i) + (SOLUTION_SQUARE * 8 / 15)

                screen.blit(value, (x_middle - value.get_width() / 2, y_middle - value.get_height() / 2))
...
def draw_helper_buttons():
    ...
    screen.blit(helper_text, (((WIDTH + RIGHT_DISTANCE) / 2) - (helper_text.get_width() / 2), TOP_DISTANCE - (SQUARE_SIZE * 4 / 3)))

    # Tip text
    tip_font = pygame.font.SysFont('Calibri', int(SQUARE_SIZE / 2.25))
    tip_text = tip_font.render("(Press 't' to toggle)", True, (50,50,50))
    screen.blit(tip_text, (((WIDTH + RIGHT_DISTANCE) / 2) - (tip_text.get_width() / 2), TOP_DISTANCE - (SQUARE_SIZE * 2 / 3)))
    ...
    if compare_grids == True:
        ...
        off_color = (255,25,25)
    pygame.draw.rect(screen, on_color, pygame.Rect(LEFT_HELPER_BUTTON_POS, TOP_HELPER_BUTTON_POS, HELPER_BUTTON_WIDTH, HELPER_BUTTON_HEIGHT), 0, -1, 4, 4, 4, 4)
    pygame.draw.rect(screen, off_color, pygame.Rect(LEFT_HELPER_BUTTON_POS, TOP_HELPER_BUTTON_POS, HELPER_BUTTON_WIDTH / 2, HELPER_BUTTON_HEIGHT), 0, -1, 4, 4, 4, 4)

    # Surrounding box
    pygame.draw.rect(screen, (50,50,50), pygame.Rect(LEFT_HELPER_BUTTON_POS, TOP_HELPER_BUTTON_POS, HELPER_BUTTON_WIDTH / 2, HELPER_BUTTON_HEIGHT), 3, -1, 4, 4, 4, 4)
    pygame.draw.rect(screen, (50,50,50), pygame.Rect(LEFT_HELPER_BUTTON_POS, TOP_HELPER_BUTTON_POS, HELPER_BUTTON_WIDTH, HELPER_BUTTON_HEIGHT), 3, -1, 4, 4, 4, 4)


def draw_title():
    title_font = pygame.font.SysFont('Calibri', int(SQUARE_SIZE))
    title_text = title_font.render("Zach's Sudoku Helper", True, (50,50,50))
    screen.blit(title_text, ((WIDTH / 2) - (title_text.get_width() / 2), SQUARE_SIZE))
    ...
    for i in range(9):
        for j in range(9):
            ...
            if cell.value != None:
                ...
                x_middle = LEFT_DISTANCE + (SQUARE_SIZE * j) + (SQUARE_SIZE * 8 / 15)
                y_middle = TOP_DISTANCE + (SQUARE_SIZE * i) + (SQUARE_SIZE * 8 / 15)
...
def draw_grid():
    ...
    tip1_text = tip_font.render("Press 'f' to solve the selected cell ", True, (50,50,50))
    tip2_text = tip_font.render("Press 'a' to solve the entire board", True, (50,50,50))
    tip3_text = tip_font.render("Press 'r' to reset the board", True, (50,50,50))

    screen.blit(tip1_text, (LEFT_DISTANCE, TOP_DISTANCE - tip1_text.get_height() * 7 / 2))
    screen.blit(tip2_text, (LEFT_DISTANCE, TOP_DISTANCE - tip2_text.get_height() * 5 / 2))
    screen.blit(tip3_text, (LEFT_DISTANCE, TOP_DISTANCE - tip2_text.get_height() * 3 / 2))
    ...
    for i in range(10):
        ...
        pygame.draw.line(screen, (50,50,50), (LEFT_DISTANCE + i * SQUARE_SIZE, TOP_DISTANCE), (LEFT_DISTANCE + i * SQUARE_SIZE, GRID_SIZE + TOP_DISTANCE), line_width)
        pygame.draw.line(screen, (50,50,50), (LEFT_DISTANCE, TOP_DISTANCE + i * SQUARE_SIZE), (GRID_SIZE + LEFT_DISTANCE, TOP_DISTANCE + i * SQUARE_SIZE), line_width)
